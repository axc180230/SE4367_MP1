...
public class TestSootLoggingHeap extends BodyTransformer {
	...
	public static void main(String[] args)	{
		...
		String mainclass = "com.axc180230.a1.HelloThread";
...
//		//set classpath
		...
		SootClass logClass = Scene.v().loadClassAndSupport("com.axc180230.a1.Log");
	...
	protected void internalTransform(Body b, String phaseName,
		...
		if(!b.getMethod().getDeclaringClass().getName().equals("com.axc180230.a1.Log"))
		{
		    ...
		    while(it.hasNext()){
		    	...
		    	if (stmt.containsFieldRef()) {
		    		...
		    		String value = stmt.getFieldRef().getField().toString();
		    		
		    		if (stmt instanceof AssignStmt) {
		    			AssignStmt assignedStmt = (AssignStmt)stmt;
		    			Value rightvalue = assignedStmt.getRightOp();
		    		...
		    		Log.logFieldAcc(Thread.currentThread(), value, fieldstatic, iswrite);
		    	}
		    }
		}
	}
